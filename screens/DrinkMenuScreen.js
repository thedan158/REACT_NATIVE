import { StyleSheet,TouchableOpacity, ScrollView, FlatList, Button, TextInput, Image, Text, View } from 'react-native'
  ...
  return (
    <SafeAreaView style={styles.droidSafeArea}>
      ...
      <View style={styles.container_header}>
        ...
        <TouchableOpacity style={styles.imgBtnCloseStyle} onPress={() => goBack()}>
