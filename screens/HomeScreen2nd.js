...
const HomeScreen2nd = () => {
  ...
  return (
    <T style={styles.container}>
              ...
              <View style={styles.containerMenuInfo}>
                ...
                >
                  <ImageBackground
                    ...
                    style={{ height: 160, width: 160, flex: 1, marginRight: 0 }}
                    resizeMode="contain"
                  />
                </View>
              </View>
      ...
      {/* Devide line */}
      <View style={styles.containerLineDevide}></View>
      {/* Container bottom */}
        ...
        <TouchableOpacity style={styles.btnExclusivelyDeal}>
          ...
          >
            <View style={styles.containerBottomSection}>
              ...
              <View style={{ flex: 1 }}>
                <Image
                  source={require("../assets/images/Artboard1.png")}
                  style={styles.imgExclusiveSale}
                />
              </View>
            </View>
          </LinearGradient>
